...
"%JAVA_HOME%\bin\jpackage.exe" --type app-image --name "%APP_NAME%" --input "%PKG_INPUT%" --main-jar "%JAR_BASENAME%" --main-class com.cuahang.main.MainApp --dest "%OUT_DIR%" --app-version 0.0.1
